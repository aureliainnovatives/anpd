from PyQt6.QtWidgets import (QMainWindow, QWidget, QVBoxLayout, QPushButton, QLabel, QFileDialog, QHBoxLayout, QMessageBox)
        ...
        try:
            ...
            try:
                ...
                QMessageBox.critical(
                    ...
                    f"Failed to initialize the detector. Please check your internet connection and try again.\n\nError: {str(e)}"
                )
                raise
